      ...
      <div className="container">
          ...
          <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
            <div className="mb-12 max-w-[360px] lg:mb-16">
              <Link href="/" className="mb-8 inline-block">
                <h2 className="text-xl font-bold leading-tight text-black dark:text-white sm:leading-tight md:leading-tight">
                  Microdiving
                </h2>
              </Link>
              <p className="mb-9 text-base leading-relaxed text-body-color dark:text-body-color-dark">
                Transform Fashion with Microdiving: Where Your Ideas Meet Innovation.
              </p>
              <div className="flex items-center">
                <a
                  href="https://t.me/microdiving"
                ...
                <a
                  href="https://www.youtube.com/@Microdiving"
                  aria-label="social-link"
                  className="mr-6 text-body-color duration-300 hover:text-primary dark:text-body-color-dark dark:hover:text-primary"
                >
                ...
                <a
                  href="https://www.instagram.com/microdiving_mic?igsh=ODdydWFpdW90d3Nq"
                  aria-label="social-link"
        ...
        <div className="py-8">
          <p className="text-center text-base text-body-color dark:text-white">
            © {String(new Date().getUTCFullYear())} Microdiving. All rights reserved.
          </p>
        </div>
      </div>
